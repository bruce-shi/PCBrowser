...
public class LoginFragment extends Fragment {
    ...
    private void login(){
        EditText unWidget = (EditText)this.getView().findViewById(R.id.login_username);
        EditText  pwWdiget = (EditText)this.getView().findViewById(R.id.login_password);


        String username= unWidget.getText().toString();
        String password = pwWdiget.getText().toString();
        ...
        client.post(PCConstant.SERVER_BASE_URL + "/mobile_login/", params, new JsonHttpResponseHandler() {
            @Override
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                try {
                    if (response.getBoolean("status")) {
                        ...
                        editor.putString(getString(R.string.appkey), response.getString("appkey"));
